...
points(Particle.Gradients.10, Liquid.First.Turn, col=predict(final_model), pch=1, cex=1.5)
...
points(Particle.Gradients.20, Liquid.First.Turn, col=predict(final_model), pch=1, cex=1.5)
legend("topleft", legend=c("Bijel", "Non-bijel", "Pred bijel", "Pred non-bijel"), pch=c(16,16,1,1), col=c("red", "black", "red", "black"), cex=0.7)
...
points(Particle.Gradients.10, Particle.Gradients.20, col=predict(final_model), pch=1, cex=1.5)
legend("topleft", legend=c("Bijel", "Non-bijel", "Pred bijel", "Pred non-bijel"), pch=c(16,16,1,1), col=c("red", "black", "red", "black"), cex=0.7)
